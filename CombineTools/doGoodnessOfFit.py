...
os.system('combine -M GoodnessOfFit asymmCards/combined_mutau_2018_60_20.root --algo saturated -m 60 --freezeParameters MH -n .goodnessOfFit_data')

# Takes a long time! ~30 minutes even, for 500 toys
os.system('combine -M GoodnessOfFit asymmCards/combined_mutau_2018_60_20.root  --algo saturated -m 60 --freezeParameters MH -n .goodnessOfFit_toys -t 500')
